                        ...
                        <div class="row">
                            <div class="col-xl-6 col-lg-7 col-md-12">
                                <div class="hero__caption">
                                    ...
                                    <p data-animation="fadeInLeft" data-delay="0.4s">Teaching tool to assist each and every student to learn in an interactive manner.<br>By Vladi Kruk ,Almog Shmul and Ron Ofir<br>HIT - Devops Course</p>
                                </div>
                            </div>
                        </div>
                    </div>
